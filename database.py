...
LOGO_URL = "https://i.ibb.co/TqxbQnsq/Imagen-de-Whats-App-2025-04-23-a-las-10-14-29-559a5c08.jpg"
...
def expandir_rango_fechas(desde, hasta):
    ...
    hasta_dt = datetime.datetime.strptime(hasta, '%Y-%m-%d') + datetime.timedelta(days=1) - datetime.timedelta(
        seconds=1)
...
def build_pdf_advanced(
    ...
    base_style = [
        ...
        ("LINEBELOW", (0, 0), (-1, 0), 0.5, colors.HexColor("#6e5407")),
        ("VALIGN", (0, 0), (-1, -1), "TOP"),
        ...
        ("GRID", (0, 0), (-1, -1), 0.25, colors.HexColor("#6e5407")),
        ("ROWBACKGROUNDS", (0, 1), (-1, -1), [
            colors.HexColor("#fae1b1"),  # azul muy pálido
            colors.HexColor("#fcebdc"),
        ]),
    ]
    if extra_styles:
